...
public class HeadSkins {
    ...
    public static ItemStack FacebookSkin() {
        return SkullCreator.itemFromBase64(facebookSkin);
    }

    public static ItemStack TwitchSkin() {
        return SkullCreator.itemFromBase64(twitchSkin);
    }

    public static ItemStack DiscordSkin() {
        return SkullCreator.itemFromBase64(discordSkin);
    }

    public static ItemStack InstagramSkin() {
        return SkullCreator.itemFromBase64(instagramSkin);
    }

    public static ItemStack StoreSkin() {
        return SkullCreator.itemFromBase64(storeSkin);
    }
}